...
export default function Profile() {
  ...
  const [activeTab, setActiveTab] = useState('favorites'); // 'favorites' or 'posted'
  ...
  console.log("userData.likedProperties:", userData.likedProperties);
  console.log("userData.postedProperties:", userData.postedProperties);
  ...
  console.log("Transformed validLikedProperties:", validLikedProperties);
  console.log("Transformed validPostedProperties:", validPostedProperties);
  ...
  const PropertyCard = ({ property, likedAt, postedAt, status, showDelete = false, onDelete, onUnlike }) => {
    console.log("PropertyCard rendering with:", { property, likedAt, postedAt, status });
            ...
            <>
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex gap-2">
                  <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm font-medium">
                    {validPostedProperties.length} properties
                  </span>
                  <button
