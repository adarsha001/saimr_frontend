    ...
    <div ref={sectionRef} className="relative w-full p-4 min-h-[120vh] md:min-h-[100vh] bg-white overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/*
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-white via-white/80 to-transparent opacity-95"></div>
        */}
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 lg:pt-20 pb-12">
        ...
        <div className="max-w-4xl mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-700 leading-relaxed max-w-2xl">
            ...
            with prime land opportunities. Our expertise spans **Joint Developments**, **Joint Ventures**, and 
            **Outright Land Sales**, focusing exclusively on clear-title properties in strategic locations across Karnataka.
          </p>
        </div>

        {/* Stats Grid */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12 sm:mb-20 max-w-4xl">
          {stats.map((stat, idx) => (
            <div 
              key={idx}
        ...
        <div className="max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {services.map((service, idx) => (
                <div 
                    key={idx} 
                    // Keeping a white/90 background on these boxes for readability against potentially busy image areas
                    className={`bg-white/90 p-6 border-l-4 ${service.color} shadow-md hover:shadow-lg transition-all duration-300 backdrop-blur-sm`}
                >
      ...
      {/* WhatsApp Button - Kept for completeness */}
      <a 
