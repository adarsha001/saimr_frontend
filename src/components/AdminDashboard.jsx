...
import AdminClickAnalytics from "./AdminClickAnalytics"; // Import the analytics component
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-4">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span className="font-medium text-gray-900 capitalize">{activeSection}</span>
          </div>
        </div>
